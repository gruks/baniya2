...
export const NODE_REGISTRY: NodeMeta[] = [
    ...
    configSchema: [
      {
        ...
        required: false,
        placeholder: '{}',
        description: 'Default payload when triggered manually',
      },
    ],
  },
  {
  ...
  // ─── AI Nodes ───────────────────────────────────────────
  {
    ...
    configSchema: [
      ...
      {
        key: 'preferredLocalModel',
        label: 'Preferred Local Model',
        type: 'text',
        default: 'llama3.2',
      },
      {
        key: 'preferredCloudModel',
        label: 'Preferred Cloud Model',
        type: 'select',
        options: [
  ...
  },
  {
    ...
    label: 'AI Agent',
    description:
      'Agentic node — LLM plans actions (write_file, run_command, read_file), node executes them directly.',
    category: 'ai',
    color: '#059669',
    icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm1 14.93V15a1 1 0 0 0-2 0v1.93A8.001 8.001 0 0 1 4.07 11H5a1 1 0 0 0 0-2H4.07A8.001 8.001 0 0 1 11 4.07V5a1 1 0 0 0 2 0V4.07A8.001 8.001 0 0 1 19.93 11H19a1 1 0 0 0 0 2h.93A8.001 8.001 0 0 1 13 16.93z',
    handles: {
      inputs: [{ id: 'in', label: 'Input', type: 'target' }],
      outputs: [
    ...
    configSchema: [
      {
        ...
        required: true,
        placeholder:
          'Create a hello world Python script. Use {{ input.folderPath }} as the working directory.',
      },
      {
        key: 'folderPath',
        ...
        type: 'text',
        placeholder:
          'Leave blank to use upstream folderPath from Folder Connect node',
      },
      {
        key: 'model',
        label: 'Model',
  ...
  },
  {
    ...
    label: 'Ollama',
    description:
      'Run a prompt directly on a local Ollama model. Free, private, no API key needed.',
    category: 'ai',
    color: '#0D9E75',
    ...
    configSchema: [
      {
        ...
        required: true,
        placeholder:
          'Your prompt. Use {{ input.content }} to pass upstream data.',
      },
      {
        key: 'model',
        label: 'Model',
        ...
        description: 'Ollama model name. Leave blank to use server default.',
      },
      {
        key: 'systemPrompt',
        label: 'System Prompt',
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'http://localhost:11434',
        description: 'Leave blank to use server default (BANIYA_OLLAMA_URL).',
      },
      {
        key: 'maxTokens',
        label: 'Max Tokens',
    ...
    configSchema: [
      {
        ...
        type: 'code',
        required: true,
        placeholder: "input.sentiment === 'negative'",
        description:
          'JS expression returning boolean. `input` available as variable.',
      },
    ],
  },
  {
    ...
    configSchema: [
      {
        ...
        type: 'text',
        placeholder: 'items',
        description: 'Field name containing the array to iterate',
      },
    ],
  },
  {
    ...
    configSchema: [
      {
        ...
        type: 'code',
        required: true,
        placeholder: 'return { ...input, newField: input.value.toUpperCase() }',
        description:
          'JS expression. `input` is available. Must return transformed value.',
      },
    ],
  },
  {
    ...
    configSchema: [
      {
        ...
        description:
          'JS expression. `item` is available for each array element.',
      },
    ],
  },
  {
    ...
    configSchema: [
      {
        ...
        description:
          'Relative path from storage base dir (e.g. folder/file.txt). Absolute paths like C:/ or D:/ are forbidden.',
      },
      {
        key: 'encoding',
        label: 'Encoding',
    ...
    configSchema: [
      {
        ...
        placeholder: 'data/output.txt',
        description:
          'Relative path from storage base dir. Absolute paths are forbidden. Use {{ input.path }} for dynamic paths.',
      },
      {
        key: 'content',
        label: 'Content',
        ...
        description: 'Content to write. Supports {{ input.field }} templates.',
      },
      {
        key: 'append',
        label: 'Mode',
    ...
    configSchema: [
      {
        ...
        placeholder: 'data/',
        description:
          'Relative path from storage base dir. Absolute paths are forbidden.',
      },
      {
        key: 'recursive',
        label: 'Recursive',
    ...
    configSchema: [
      {
        ...
        type: 'text',
        placeholder: 'debug',
        description: 'Label for log entry',
      },
    ],
  },
];
...
NODE_REGISTRY.push(
  {
    type: 'agent.execute',
    label: 'Execute Agent',
    description: 'Run an agent with structured input and tools',
    category: 'agent',
    color: '#8B5CF6',
    icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm1 14.93V15a1 1 0 0 0-2 0v1.93A8.001 8.001 0 0 1 4.07 11H5a1 1 0 0 0 0-2H4.07A8.001 8.001 0 0 1 11 4.07V5a1 1 0 0 0 2 0V4.07A8.001 8.001 0 0 1 19.93 11H19a1 1 0 0 0 0 2h.93A8.001 8.001 0 0 1 13 16.93z',
    handles: {
    ...
    configSchema: [
      {
        ...
        description: 'ID of the agent template to execute',
      },
      {
        key: 'maxIterations',
  ...
  },
  {
    ...
    handles: {
      inputs: [{ id: 'in', label: 'Message', type: 'target' }],
      outputs: [
        { id: 'main', label: 'Response', type: 'source' },
        { id: 'error', label: 'Error', type: 'source' },
      ],
    },
    configSchema: [
      {
        ...
        required: true,
        placeholder: 'planner',
        description: 'ID of the agent template to chat with',
      },
      {
        key: 'maxIterations',
        label: 'Max Iterations',
        ...
        min: 1,
        max: 50,
        description: 'Maximum iterations per message',
      },
    ],
  }
);
...
NODE_REGISTRY.push(
  {
    ...
    label: 'Folder',
    description:
      'Connect to any local folder. Outputs file listing for downstream AI nodes.',
    category: 'storage',
    color: '#EA580C',
    icon: 'M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z',
    handles: {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'text',
        placeholder: '*.ts',
        description: 'Optional glob to filter files, e.g. *.md',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    label: 'Folder Read',
    description:
      'Read a file from the connected folder and pass content to AI.',
    category: 'storage',
    color: '#EA580C',
    icon: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M16 13H8 M16 17H8 M10 9H8',
    handles: {
    ...
    configSchema: [
      ...
      },
      {
        ...
        description:
          'Relative path inside the folder. Supports {{ input.path }} from upstream.',
      },
    ],
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'textarea',
        placeholder: '{{ input.text }}',
        description: 'Use {{ input.text }} to write AI output.',
      },
      {
        key: 'mode',
        label: 'Mode',
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Exact text to replace. Supports {{ input.oldStr }}.',
      },
      {
        key: 'newStr',
        label: 'New String',
        type: 'textarea',
        required: true,
        placeholder: 'Replacement text. Supports {{ input.newStr }}.',
      },
    ],
  }
);
